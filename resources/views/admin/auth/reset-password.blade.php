                ...
                <div class="row">
                    <div
                        ...
                        <div class="card card-primary">
                            ...
                            <div class="card-body">
                                @if (session('error'))
                                    <i><b style="color: red">{{ session('error') }}</b></i>
                                @endif
                                <form method="POST" action="{{ route('admin.reset-password.send') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{ $_GET['email'] }}" id="email" type="email"
                                    ...
                                    <div class="form-group">
                                        <div class="d-block">
                                            <label for="password_confirmation"
                                                class="control-label">{{ __('admin.Password
                                                                                            Confirm') }}</label>
                                        </div>
                                        <input id="password_confirmation" type="password" class="form-control"
                                            name="password_confirmation" tabindex="2" required>
                                        <div class="invalid-feedback">
                                            {{ __('admin.please fill in your password confirm') }}
                                        </div>
                        ...
                        <div class="simple-footer">
                            {{ __('admin.Copyright') }} &copy; Developer 2024
                        </div>
                    </div>
                </div>
            </div>
