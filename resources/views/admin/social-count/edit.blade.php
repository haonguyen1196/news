            ...
            <div class="card-body">
                <form action="{{ route('admin.social-count.update', $socialCount->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select name="lang" class="form-control select2">
                            ...
                            @foreach ($langs as $lang)
                                <option @selected($socialCount->lang == $lang->lang) value="{{ $lang->lang }}">{{ $lang->name }}
                                </option>
                            @endforeach
                        </select>
                        @error('lang')
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $socialCount->fan_count }}" name="fan_count" type="text" class="form-control">
                        @error('fan_count')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $socialCount->fan_type }}" name="fan_type" type="text" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $socialCount->button_text }}" name="button_text" type="text"
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" id="" class="form-control">
                            <option @selected($socialCount->status == 1) value="1">{{ __('admin.Active') }}</option>
                            <option @selected($socialCount->status == 0) value="0">{{ __('admin.Inactive') }}</option>
                        </select>
                        @error('status')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
