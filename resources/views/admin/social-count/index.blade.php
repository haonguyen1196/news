                        ...
                        <div class="tab-pane fade show {{ $loop->index == 0 ? 'active' : '' }}"
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped" id="table-{{ $lang->lang }}">
                                    ...
                                    <tbody>
                                        @php
                                            $socialCounts = \App\Models\SocialCount::where('lang', $lang->lang)
                                                ->latest()
                                                ->get();
                                        @endphp
                                        @foreach ($socialCounts as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.social-count.edit', $item->id) }}"
                                                        class="btn btn-primary"><i class="fas fa-edit"></i></a>
                                                    <a href="{{ route('admin.social-count.destroy', $item->id) }}"
