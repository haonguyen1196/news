...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('ads', function (Blueprint $table) {
            ...
            $table->text('home_middle_bar_ad');
            $table->boolean('home_middle_bar_ad_status');
            $table->text('home_middle_bar_ad_url')->nullable();
            $table->text('views_page_ad');
            $table->boolean('views_page_ad_status');
            $table->text('views_page_ad_url')->nullable();
